...
public class WebSocketController {
    ...
    private static ConcurrentHashMap<String,WebSocketController> map=new ConcurrentHashMap();
    //每个连接都会有自己的会话
    ...
    public void getMessage(String message) throws IOException {
        ...
        Set<Map.Entry<String, WebSocketController>> entries = map.entrySet();
        for (Map.Entry<String, WebSocketController> entry : entries) {
